...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SchoolMonitor</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <!-- Sidebar user panel -->
      <div class="user-panel" style="color:#FFF;text-align:center;">
      <p>
          <?php
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo '?token='.base64_encode('dashboard') ?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo '?token='.base64_encode('enter_student') ?>"><i class="fa fa-circle-o"></i>Add Students</a></li>
            <li><a href="<?php echo '?token='.base64_encode('view_students') ?>"><i class="fa fa-circle-o"></i> View Students </a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu" style="display: none;">
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo '?token='.base64_encode('grading') ?>"><i class="fa fa-circle-o"></i>Grading</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://adminlte.io">Scosoft Systems Inc.</a>.</strong> All rights
    reserved.
  </footer>
